                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    {{-- <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdown-phone-3"
                                        ...
                                        type="button">
                                        <svg fill="none" aria-hidden="true" class="me-2 h-4 w-6" viewBox="0 0 20 15">
                                            <rect width="19.6" height="14" y=".5" fill="#EF3340" rx="2" />
                                            <rect width="19.6" height="4.67" y="4.67" fill="#FFF" />
                                            <rect width="19.6" height="4.67" y="9.33" fill="#000" />
                                            <path fill="#CDA434" d="M9.6 5.5h1.8v3.2H9.6z" />
                                            <path fill="#CDA434" d="M9.9 8.7h1.2l-.6 1z" />
                                        </svg>
                                        +20
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    <span class="inline-flex items-center">
                                                        ...
                                                        United States (+1)fgdfgdfgdfgdfgd
                                                    </span>
                                                </button>
                                            </li>
                                            <li>
                                    ...
                                    <div class="relative w-full">
                                        <input type="text" id="phone-input"
                                            ...
                                            pattern="01[0-9]{9}" placeholder="01119842314"
                                            required />
                                    </div>
                                </div>
                            </div>
